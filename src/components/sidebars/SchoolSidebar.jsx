...
const SchoolSidebar = ({ isOpen, setIsOpen }) => {
      ...
      >
        <div className="flex items-center justify-center h-16 px-4 border-b border-gray-200">
          <h1 className="text-xl font-bold text-gray-900">
            ...
            <span className="text-gray-600 text-sm ml-2">School</span>
          </h1>
        </div>
          ...
          <div className="space-y-1">
            {navigation.map((item) => (
              <Link
                ...
                style={{
                  backgroundColor: isCurrentPath(item.href) ? colors.primary : 'transparent',
                }}
                onClick={() => setIsOpen(false)}
              >
                <span
        ...
        <div className="absolute bottom-0 w-full p-4 border-t border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-700">Sample Academy</p>
