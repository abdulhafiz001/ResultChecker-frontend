...
const StudentResults = () => {
  ...
  const schoolInfo = {
    name: 'TermResult International School',
    logo: '/termresult logo png.png',
      ...
      <html>
        ...
        <body>
          <div class="result-content">
            ...
            <h2 style="text-align: center; color: #007cba; margin: 20px 0;">View Academic Performance and Progress</h2>
    ...
    try {
      ...
      setTimeout(() => {
        ...
        instructions.innerHTML = `
          <div style="position: fixed; top: 10px; left: 10px; background: #007cba; color: white; padding: 10px; border-radius: 5px; font-family: Arial; z-index: 1000;">
            <strong>Kindly take a screenshot</strong> of this page to save as PDF
            <button onclick="this.parentElement.remove()" style="margin-left: 10px; background: white; color: #007cba; border: none; padding: 5px; border-radius: 3px; cursor: pointer;">×</button>
          </div>
        `;
