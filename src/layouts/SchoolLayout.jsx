...
function SchoolLayout() {
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-100">
      <SchoolSidebar isOpen={sidebarOpen} setIsOpen={setSidebarOpen} />
            ...
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <div className="ml-3 relative">
                <div>
                  <button
                    type="button"
                    className="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2"
                    style={{ focusRingColor: colors.primary }}
                    id="user-menu-button"
                    aria-expanded="false"
                    aria-haspopup="true"
